...
#define FOLLOWERS "/followers?include=data%5B*%5D.answer_count,articles_count,follower_count,is_followed,is_following,badge%5B?(type=best_answerer)%5D.topics"
...
#define TOTALOFFSET "&offset=0"
#define TOTALLIMIT "&limit=1"
...
/* filter followers */
#define FOLLOWERANSWER 100
#define FOLLOWERNUM 200

#define START_FILE "./startfile/seeds.txt"
#define RAWDATA "./startfile/rawdata"
#endif /* SRC_CONFIG_H_ */
